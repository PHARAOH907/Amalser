...
module.exports = {
    ...
    PHONE: process.env.NUMBER === undefined ? '+919605463225' : process.env.NUMBER,   
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '919605463225@s.whatsapp.net' : process.env.TAG_REPLY,
